        ...
        * */
        ...
        private void Button_PercentRace_Click(object sender, EventArgs e)
        {
            ...
            {   //Declare variables
                ...
                {
                    TextBox_Output.AppendText((Race)r + ": " + (raceNum[r] / playerNum * 100) + "%\n");
                }
